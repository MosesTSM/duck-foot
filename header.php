	...
	<div id="container">
		<div class="menu-popup">
			...
			<div class="mobile-nav-controls">
				<a class="close-nav">
					<svg id="menu-close" x="0px" y="0px" viewBox="0 0 50 50" width="25" height="25" preserveAspectRatio="xMidYMid meet">
						<g>
				...
				<a class="back-nav">
					<svg id="menu-back" x="0px" y="0px" viewBox="0 0 25 25" width="25" height="25" preserveAspectRatio="xMidYMid meet">
		...
		<header>
			<a href="<?php bloginfo('url'); ?>/" class="header-logo-link">
				<svg class="header-logo" x="0px" y="0px" viewBox="0 0 360 240" width="360" height="240" preserveAspectRatio="xMidYMid meet">
					...
					<g class="logo-foot">
						...
						<path d="M285.8,52.5l-1.3-1.1l3.5-4.6l1.3,1.1l-1.1,1.5l5,3.8l-1.2,1.6l-5-3.8L285.8,52.5z"/>
						<path d="M291.6,46.7L291.6,46.7l1.8,1.5l2.1,1.7l-1.1,1.5l-6.1-5l1.6-2.1l2.1,0.9l2.8,1.2l0,0l-1.9-2.4l-1.4-1.8 l1.6-2.1l6.5,4.6l-1.2,1.6l-2.2-1.6l-1.9-1.4l0,0l3.2,4.2l-1,1.3L291.6,46.7z"/>
					</g>
				</svg>
			</a>
			...
			<div class="mobile-nav">
				<a class="button nav-button phone-link">
					<span class="mobile-hide"><?php the_field('sales_phone','option'); ?></span>
					<span class="mobile-show">Call</span>
				</a>
				<a class="button nav-button">
					<span>Order</span> 
					<span class="mobile-hide">Now</span>
				</a>
				<a class="button hamburger nav-button">
					<span class="ham-close">Close</span>
					<span class="ham-open">Menu</span>
				</a>
			</div>
		</header>

		<div class="window-border window-border-y window-border-top"></div>
		<main>
			<div class="window-border window-border-x  window-border-right"></div>
			<div class="window-border window-border-x window-border-left"></div>
			<div class="window-border window-border-y window-border-bottom"></div>